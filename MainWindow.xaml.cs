...
namespace MinesweeperWPF
{
    ...
    public partial class MainWindow : Window
    {
        ...
        {
            if (taille_8!=null) taille_8.IsChecked = true;
            if (taille_9 != null) taille_9.IsChecked = false;
            if (taille_16 != null) taille_16.IsChecked = false;
            gridSize = 8;
            nbMines = 10;
            initialisation();
        }
        ...
        {
            if (taille_8 != null) taille_8.IsChecked = false;
            if (taille_9 != null) taille_9.IsChecked = true;
            if (taille_16 != null) taille_16.IsChecked = false;
            gridSize = 9;
            nbMines = 12;
            initialisation();
        ...
        private void taille16_checked(object sender, RoutedEventArgs e)
        {
            if (taille_8 != null) taille_8.IsChecked = false;
            if (taille_9 != null) taille_9.IsChecked = false;
            if (taille_16 != null) taille_16.IsChecked = true;
            gridSize = 16;
            nbMines = 40;
            initialisation();
        }
